...
rm f90getopt.o force_field_mod.mod  header.o minimization_mod.mod parser_mod.mod f90getopt.mod force_field_calc.o header_mod.mod main.o minimization.o parser.o
